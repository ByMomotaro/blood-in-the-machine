...
const Data := preload('room_g_apartment_state.gd')

var state: Data = load("res://game/rooms/g_apartment/room_g_apartment.tres")

@onready var apartment_starting_position: Marker2D = $Markers/ApartmentStartingPosition
...
func _on_room_entered() -> void:
	C.player.position = apartment_starting_position.position
