...
const Data := preload('room_a_dead_body_state.gd')

var state: Data = load("res://game/rooms/a_dead_body/room_a_dead_body.tres")

@onready var dead_body_arm: Area2D = $Props/DeadBodyArm
@onready var arm_des_zeugen: Area2D = $Hotspots/ArmDesZeugen
