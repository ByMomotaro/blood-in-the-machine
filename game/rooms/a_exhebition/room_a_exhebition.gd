...
const Data := preload('room_a_exhebition_state.gd')

var state: Data = load("res://game/rooms/a_exhebition/room_a_exhebition.tres")
@onready var starting_position: Marker2D = $Markers/ExhebitionStartingPosition
