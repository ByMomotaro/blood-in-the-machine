...
const Data := preload('inventory_item_information_arm_zeuge_vergiftet_state.gd')

var state: Data = load("res://game/inventory_items/information_arm_zeuge_vergiftet/inventory_item_information_arm_zeuge_vergiftet.tres")
