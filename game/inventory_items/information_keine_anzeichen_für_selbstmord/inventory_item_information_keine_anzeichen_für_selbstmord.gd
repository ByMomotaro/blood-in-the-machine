...
const Data := preload('inventory_item_information_keine_anzeichen_für_selbstmord_state.gd')

var state: Data = load("res://game/inventory_items/information_keine_anzeichen_für_selbstmord/inventory_item_information_keine_anzeichen_für_selbstmord.tres")
