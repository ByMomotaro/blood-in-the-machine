...
const Data := preload('inventory_item_item_phiole_mit_nervengift_state.gd')

var state: Data = load("res://game/inventory_items/item_phiole_mit_nervengift/inventory_item_item_phiole_mit_nervengift.tres")
