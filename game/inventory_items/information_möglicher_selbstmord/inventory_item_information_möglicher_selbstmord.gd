...
const Data := preload('inventory_item_information_möglicher_selbstmord_state.gd')

var state: Data = load("res://game/inventory_items/information_möglicher_selbstmord/inventory_item_information_möglicher_selbstmord.tres")
