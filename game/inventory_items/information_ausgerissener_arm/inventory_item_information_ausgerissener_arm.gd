...
const Data := preload('inventory_item_information_ausgerissener_arm_state.gd')

var state: Data = load("res://game/inventory_items/information_ausgerissener_arm/inventory_item_information_ausgerissener_arm.tres")
