...
const Data := preload('inventory_item_item_phiole_mit_grüner_flüssigkeit_state.gd')

var state: Data = load("res://game/inventory_items/item_phiole_mit_grüner_flüssigkeit/inventory_item_item_phiole_mit_grüner_flüssigkeit.tres")
