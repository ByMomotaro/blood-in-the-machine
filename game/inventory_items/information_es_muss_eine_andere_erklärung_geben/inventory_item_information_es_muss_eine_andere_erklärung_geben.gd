...
const Data := preload('inventory_item_information_es_muss_eine_andere_erklärung_geben_state.gd')

var state: Data = load("res://game/inventory_items/information_es_muss_eine_andere_erklärung_geben/inventory_item_information_es_muss_eine_andere_erklärung_geben.tres")
