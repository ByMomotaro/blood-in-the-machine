...
const Data := preload('character_pyr_soldier_a_state.gd')

var state: Data = load("res://game/characters/pyr_soldier_a/character_pyr_soldier_a.tres")
...
func _on_click() -> void:
	#dialogue_runner.StartDialogueForget("exhebition_pyr_soldier_a_dialogue")
	E.command_fallback()
