...
const Data := preload('character_zeuge_a_state.gd')

var state: Data = load("res://game/characters/zeuge_a/character_zeuge_a.tres")
...
func _on_click() -> void:
	...
	DialogueManager.start_dialogue("ExhebitionZeugeA")
