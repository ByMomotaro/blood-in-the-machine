...
const Data := preload('character_zeuge_b_state.gd')

var state: Data = load("res://game/characters/zeuge_b/character_zeuge_b.tres")
...
func _on_click() -> void:
	...
	DialogueManager.start_dialogue("ExhebitionZeugeB")
	I.InformationMöglicherSelbstmord.add()
	I.InformationAusgerissenerArm.add()
